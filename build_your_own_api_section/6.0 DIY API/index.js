...
app.get("/jokes/:id", (req, res) => {
  try {
    ...
    console.error(error);
    res.status(404).json({ error: error.stack, message: error.message });
  }
});
...
app.post("/jokes", (req, res) => {
  try {
    ...
    console.error(error);
    res.status(500).json({ error: error.stack, message: error.message });
  }
});
...
app.delete("/all", (req, res) => {
  try {
    ...
    console.error(error);
    res.status(401).json({ error: error.stack, message: error.message });
  }
});
